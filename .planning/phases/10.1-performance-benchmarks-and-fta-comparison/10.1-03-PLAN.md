  ...
  <action>
    ...
    2. **Create `benchmarks/scripts/compare_metrics.py`**:
       ...
       - For each file that appears in BOTH outputs:
         ...
         b. **Halstead volume**: CG file-level = sum of per-function halstead_volume; FTA = `halstead_volume` field (if present)
...
<task type="auto">
  ...
  <done>
    benchmarks/README.md provides practical how-to for running benchmarks. docs/benchmarks.md provides polished summary with methodology, findings, and baseline context for Phase 11/12. README.md and publication README link to benchmark documentation.
  </done>
</task>
