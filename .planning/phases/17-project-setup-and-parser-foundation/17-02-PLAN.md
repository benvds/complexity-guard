...
must_haves:
  ...
  artifacts:
    ...
    - path: "rust/src/lib.rs"
      provides: "Crate root re-exporting types and parser modules for integration test access"
      contains: "pub mod types; pub mod parser;"
  ...
  key_links:
    ...
    - from: "rust/tests/parser_tests.rs"
      to: "rust/src/lib.rs"
      via: "crate root re-exports pub mod types; pub mod parser;"
      pattern: "complexity_guard::"
    - from: "rust/tests/parser_tests.rs"
      to: "tests/fixtures/"
