...
- Homebrew: own tap first (brew install yourname/tap/complexity-guard), submit to homebrew-core later once popular
...
class ComplexityGuard < Formula
  ...
  homepage "https://github.com/yourname/complexity-guard"
  version "0.1.0"

  if OS.mac? && Hardware::CPU.arm?
    url "https://github.com/yourname/complexity-guard/releases/download/v0.1.0/complexity-guard-aarch64-macos.tar.gz"
    sha256 "abc123..." # shasum -a 256 complexity-guard-aarch64-macos.tar.gz
  elsif OS.mac? && Hardware::CPU.intel?
    url "https://github.com/yourname/complexity-guard/releases/download/v0.1.0/complexity-guard-x86_64-macos.tar.gz"
    sha256 "def456..."
  elsif OS.linux? && Hardware::CPU.arm?
    url "https://github.com/yourname/complexity-guard/releases/download/v0.1.0/complexity-guard-aarch64-linux.tar.gz"
    sha256 "ghi789..."
  elsif OS.linux? && Hardware::CPU.intel?
    url "https://github.com/yourname/complexity-guard/releases/download/v0.1.0/complexity-guard-x86_64-linux.tar.gz"
    sha256 "jkl012..."
  end
...
**What goes wrong:** User runs `brew install yourname/tap/complexity-guard`, Homebrew says "tap not found" or "formula not found".
...
4. User taps with `brew tap yourname/tap` (not `yourname/homebrew-tap`)

**Warning signs:** `brew tap yourname/tap` succeeds but `brew install yourname/tap/complexity-guard` fails; formula works locally with `brew install --build-from-source ./formula.rb` but not via tap.
...
[Unreleased]: https://github.com/yourname/complexity-guard/compare/v0.1.0...HEAD
[0.1.0]: https://github.com/yourname/complexity-guard/releases/tag/v0.1.0
```
