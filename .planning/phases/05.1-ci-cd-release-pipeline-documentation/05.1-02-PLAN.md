...
```json
{
  ...
  "repository": {
    "type": "git",
    "url": "https://github.com/user/complexity-guard"
  },
...
<task type="auto">
  ...
  <action>
Create homebrew/complexity-guard.rb as a Homebrew formula template. Per user decision: own tap first (brew install yourname/tap/complexity-guard).

The formula:
- Class: ComplexityGuard < Formula
- desc: "Fast complexity analysis for TypeScript/JavaScript"
- homepage: "https://github.com/user/complexity-guard" (placeholder URL)
- version: "0.1.0"
- license: "MIT"
...
- URLs point to GitHub releases: https://github.com/user/complexity-guard/releases/download/v#{version}/complexity-guard-<target>.tar.gz
